# C3v s12 full diagnostic — 遵守实验铁律
# 从头开始，不加载 checkpoint，走 debug 线 lib/ 源代码
# 模板：C4v s12 成功实验
#
# 背景：C3v 点群 (|G|=6, SG#156)，s12 模式
# 之前因 GCD_INT 崩溃，是最困难的测试用例
# p+ip 层可能在 d2 后存活，这是与 C4v/SG#30 的关键区别
