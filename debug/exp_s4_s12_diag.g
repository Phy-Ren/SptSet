# S4 s12 full diagnostic — 遵守实验铁律
# 从头开始，不加载 checkpoint，走 debug 线 lib/ 源代码
# 模板：C4v s12 成功实验
#
# 背景：S4 点群 (|G|=4, SG#81)，s12 模式
# 之前的笔记记录 S4 s12 给出 Z4，而外部文献期望 Z2×Z2
# 本次用 debug 代码从头验证，并检查是否有分数问题
