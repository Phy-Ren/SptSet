# SG#100 (P4bm) EZ diagnostic with CHECKPOINT — debug line
# Resume: gap -L ~/checkpoints/sg100_diag.ws -b this_script.g
...
Print("================================================================\n");;
Print("SG#100 (P4bm) EZ diagnostic [CHECKPOINT ENABLED]\n");;
...
CKPT_FILE := "~/checkpoints/sg100_diag.ws";;
CKPT_SAVE := function()
