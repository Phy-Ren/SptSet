# SG#42 (Fmm2) EZ full diagnostic — 遵守实验铁律
# 从头开始，不加载 checkpoint，走 debug 线 lib/ 源代码
# 模板：SG#22 EZ 成功实验
#
# 背景：SG#42 是生产线上唯二 ModRat 崩溃群之一（另一个是 SG#22，已通过）
# 崩溃点与 SG#22 相同：Phase B ext layer 2 → ModRat 错误
...
Print("================================================================\n");;
Print("SG#42 (Fmm2) EZ diagnostic\n");;
...
Print("Building resolution for SG#42...\n");;
_t := NanosecondsSinceEpoch();;
SG := SpaceGroupBBNWZ(3, 42);;
