...
Print("================================================================\n");;
Print("C4v s12 (SG#99) FULL diagnostic trace\n");;
...
#
# Coboundary formulas produce Q/Z values (fractions expected).
# Bockstein converts to Z (integers required).
# If output has fractions => formula didn't produce valid Q/Z cocycle.
#
# SptSetBockstein is a GlobalFunction => replace with wrapper.
# ==============================================================
...
# C3v crashed here. Logging then delegating to original method.
#
# SptSetFpZModuleCanonicalForm is an Operation => InstallMethod.
# ==============================================================
...
#
# Confirmed NOT the source for C3v/C4v, kept for completeness.
#
# SptSetZLMapInverse is an Operation => InstallMethod.
# ==============================================================
...
# ==============================================================
Print("Setting up C4v s12 (SG#99)...\n");;
