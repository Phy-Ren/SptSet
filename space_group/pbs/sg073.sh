...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg073.g
set CKPT = ~/checkpoints/sg73.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg073.log

echo "=== SptSet Space Group #73 ===" >>& $LOG
