...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg029.g
set CKPT = ~/checkpoints/sg29.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg029.log

echo "=== SptSet Space Group #29 (bigmem node) ===" >& $LOG
