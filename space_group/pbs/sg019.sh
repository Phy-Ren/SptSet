...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg019.g
set CKPT = ~/checkpoints/sg19.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg019.log

echo "=== SptSet Space Group #19 (bigmem node) ===" >>& $LOG
