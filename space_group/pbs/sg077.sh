...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg077.g
set CKPT = ~/checkpoints/sg77.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg077.log

echo "=== SptSet Space Group #77 ===" >>& $LOG
