...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg070.g
set CKPT = ~/checkpoints/sg70.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg070.log

echo "=== SptSet Space Group #70 ===" >>& $LOG
