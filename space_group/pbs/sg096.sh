...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg096.g
set CKPT = ~/checkpoints/sg96.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg096.log

echo "=== SptSet Space Group #96 ===" >>& $LOG
