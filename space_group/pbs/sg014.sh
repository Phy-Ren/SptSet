...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg014.g
set CKPT = ~/checkpoints/sg14.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg014.log

echo "=== SptSet Space Group #14 ===" >& $LOG
