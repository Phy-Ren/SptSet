...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg064.g
set CKPT = ~/checkpoints/sg64.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg064.log

echo "=== SptSet Space Group #64 (bigmem node) ===" >>& $LOG
