...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg074.g
set CKPT = ~/checkpoints/sg74.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg074.log

echo "=== SptSet Space Group #74 ===" >>& $LOG
