...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg055.g
set CKPT = ~/checkpoints/sg55.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg055.log

echo "=== SptSet Space Group #55 (bigmem node) ===" >>& $LOG
