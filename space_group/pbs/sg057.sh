...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg057.g
set CKPT = ~/checkpoints/sg57.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg057.log

echo "=== SptSet Space Group #57 (bigmem node) ===" >>& $LOG
