...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg048.g
set CKPT = ~/checkpoints/sg48.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg048.log

echo "=== SptSet Space Group #48 (bigmem node) ===" >>& $LOG
