...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg027.g
set CKPT = ~/checkpoints/sg27.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg027.log

echo "=== SptSet Space Group #27 (bigmem node) ===" >& $LOG
