...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg094.g
set CKPT = ~/checkpoints/sg94.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg094.log

echo "=== SptSet Space Group #94 ===" >>& $LOG
