...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg099.g
set CKPT = ~/checkpoints/sg99.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg099.log

echo "=== SptSet Space Group #99 ===" >>& $LOG
