...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg098.g
set CKPT = ~/checkpoints/sg98.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg098.log

echo "=== SptSet Space Group #98 ===" >>& $LOG
