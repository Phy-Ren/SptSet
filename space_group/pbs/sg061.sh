...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg061.g
set CKPT = ~/checkpoints/sg61.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg061.log

echo "=== SptSet Space Group #61 ===" >>& $LOG
