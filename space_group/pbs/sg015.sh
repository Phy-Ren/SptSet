...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg015.g
set CKPT = ~/checkpoints/sg15.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg015.log

echo "=== SptSet Space Group #15 ===" >& $LOG
