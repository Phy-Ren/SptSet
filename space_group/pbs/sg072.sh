...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg072.g
set CKPT = ~/checkpoints/sg72.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg072.log

echo "=== SptSet Space Group #72 (bigmem node) ===" >>& $LOG
