...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg052.g
set CKPT = ~/checkpoints/sg52.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg052.log

echo "=== SptSet Space Group #52 (bigmem node) ===" >>& $LOG
