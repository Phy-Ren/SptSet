...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg017.g
set CKPT = ~/checkpoints/sg17.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg017.log

echo "=== SptSet Space Group #17 ===" >>& $LOG
