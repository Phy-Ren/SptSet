...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg087.g
set CKPT = ~/checkpoints/sg87.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg087.log

echo "=== SptSet Space Group #87 ===" >>& $LOG
