...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg034.g
set CKPT = ~/checkpoints/sg34.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg034.log

echo "=== SptSet Space Group #34 (bigmem node) ===" >>& $LOG
