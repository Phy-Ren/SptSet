...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg039.g
set CKPT = ~/checkpoints/sg39.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg039.log

echo "=== SptSet Space Group #39 (bigmem node) ===" >& $LOG
