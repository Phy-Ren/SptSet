...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg051.g
set CKPT = ~/checkpoints/sg51.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg051.log

echo "=== SptSet Space Group #51 (bigmem node) ===" >>& $LOG
