...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg091.g
set CKPT = ~/checkpoints/sg91.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg091.log

echo "=== SptSet Space Group #91 ===" >>& $LOG
