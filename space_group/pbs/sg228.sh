...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg228.g
set CKPT = ~/checkpoints/sg228.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg228.log

echo "=== SptSet Space Group #228 (HARDEST) ===" >>& $LOG
