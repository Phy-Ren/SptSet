...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg092.g
set CKPT = ~/checkpoints/sg92.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg092.log

echo "=== SptSet Space Group #92 ===" >>& $LOG
