...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg049.g
set CKPT = ~/checkpoints/sg49.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg049.log

echo "=== SptSet Space Group #49 (bigmem node) ===" >>& $LOG
