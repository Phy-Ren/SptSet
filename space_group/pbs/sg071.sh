...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg071.g
set CKPT = ~/checkpoints/sg71.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg071.log

echo "=== SptSet Space Group #71 (bigmem node) ===" >>& $LOG
