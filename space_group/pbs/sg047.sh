...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg047.g
set CKPT = ~/checkpoints/sg47.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg047.log

echo "=== SptSet Space Group #47 (bigmem node) ===" >>& $LOG
