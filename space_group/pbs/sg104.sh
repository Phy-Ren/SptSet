...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg104.g
set CKPT = ~/checkpoints/sg104.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg104.log

echo "=== SptSet Space Group #104 ===" >>& $LOG
