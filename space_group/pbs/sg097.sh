...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg097.g
set CKPT = ~/checkpoints/sg97.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg097.log

echo "=== SptSet Space Group #97 ===" >>& $LOG
