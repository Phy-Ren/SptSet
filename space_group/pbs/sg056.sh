...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg056.g
set CKPT = ~/checkpoints/sg56.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg056.log

echo "=== SptSet Space Group #56 (bigmem node) ===" >>& $LOG
