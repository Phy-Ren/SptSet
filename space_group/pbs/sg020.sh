...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg020.g
set CKPT = ~/checkpoints/sg20.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg020.log

echo "=== SptSet Space Group #20 (bigmem node) ===" >>& $LOG
