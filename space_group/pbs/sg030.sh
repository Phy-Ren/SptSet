...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg030.g
set CKPT = ~/checkpoints/sg30.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg030.log

echo "=== SptSet Space Group #30 (bigmem node) ===" >& $LOG
