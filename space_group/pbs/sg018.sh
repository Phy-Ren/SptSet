...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg018.g
set CKPT = ~/checkpoints/sg18.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg018.log

echo "=== SptSet Space Group #18 (bigmem node) ===" >>& $LOG
