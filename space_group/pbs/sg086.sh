...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg086.g
set CKPT = ~/checkpoints/sg86.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg086.log

echo "=== SptSet Space Group #86 ===" >>& $LOG
