...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg210.g
set CKPT = ~/checkpoints/sg210.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg210.log

echo "=== SptSet Space Group #210 (HARDEST) ===" >>& $LOG
