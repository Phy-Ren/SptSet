...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg045.g
set CKPT = ~/checkpoints/sg45.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg045.log

echo "=== SptSet Space Group #45 (bigmem node) ===" >>& $LOG
