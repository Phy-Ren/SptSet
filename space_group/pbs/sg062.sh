...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg062.g
set CKPT = ~/checkpoints/sg62.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg062.log

echo "=== SptSet Space Group #62 (bigmem node) ===" >>& $LOG
