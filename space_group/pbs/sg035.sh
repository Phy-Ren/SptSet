...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg035.g
set CKPT = ~/checkpoints/sg35.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg035.log

echo "=== SptSet Space Group #35 (bigmem node) ===" >& $LOG
