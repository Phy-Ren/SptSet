...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg036.g
set CKPT = ~/checkpoints/sg36.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg036.log

echo "=== SptSet Space Group #36 (bigmem node) ===" >& $LOG
