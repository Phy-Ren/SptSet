...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg044.g
set CKPT = ~/checkpoints/sg44.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg044.log

echo "=== SptSet Space Group #44 (bigmem node) ===" >>& $LOG
