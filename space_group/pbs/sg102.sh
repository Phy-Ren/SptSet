...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg102.g
set CKPT = ~/checkpoints/sg102.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg102.log

echo "=== SptSet Space Group #102 ===" >>& $LOG
