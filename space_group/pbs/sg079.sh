...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg079.g
set CKPT = ~/checkpoints/sg79.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg079.log

echo "=== SptSet Space Group #79 ===" >>& $LOG
