...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg021.g
set CKPT = ~/checkpoints/sg21.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg021.log

echo "=== SptSet Space Group #21 (bigmem node) ===" >>& $LOG
