...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg103.g
set CKPT = ~/checkpoints/sg103.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg103.log

echo "=== SptSet Space Group #103 ===" >>& $LOG
