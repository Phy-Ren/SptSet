...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg090.g
set CKPT = ~/checkpoints/sg90.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg090.log

echo "=== SptSet Space Group #90 ===" >>& $LOG
