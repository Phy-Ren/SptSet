...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg083.g
set CKPT = ~/checkpoints/sg83.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg083.log

echo "=== SptSet Space Group #83 ===" >>& $LOG
