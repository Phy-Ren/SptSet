...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg080.g
set CKPT = ~/checkpoints/sg80.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg080.log

echo "=== SptSet Space Group #80 ===" >>& $LOG
