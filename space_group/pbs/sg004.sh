...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg004.g
set CKPT = ~/checkpoints/sg4.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg004.log

echo "=== SptSet Space Group #4 ===" >& $LOG
