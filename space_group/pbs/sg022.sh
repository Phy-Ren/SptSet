...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg022.g
set CKPT = ~/checkpoints/sg22.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg022.log

echo "=== SptSet Space Group #22 (bigmem node) ===" >>& $LOG
