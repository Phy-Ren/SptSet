...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg005.g
set CKPT = ~/checkpoints/sg5.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg005.log

echo "=== SptSet Space Group #5 ===" >& $LOG
