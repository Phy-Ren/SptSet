...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg043.g
set CKPT = ~/checkpoints/sg43.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg043.log

echo "=== SptSet Space Group #43 (bigmem node) ===" >>& $LOG
