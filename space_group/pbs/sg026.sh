...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg026.g
set CKPT = ~/checkpoints/sg26.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg026.log

echo "=== SptSet Space Group #26 (bigmem node) ===" >& $LOG
