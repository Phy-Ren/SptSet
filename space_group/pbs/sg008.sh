...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg008.g
set CKPT = ~/checkpoints/sg8.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg008.log

echo "=== SptSet Space Group #8 ===" >& $LOG
