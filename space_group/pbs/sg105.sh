...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg105.g
set CKPT = ~/checkpoints/sg105.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg105.log

echo "=== SptSet Space Group #105 ===" >>& $LOG
