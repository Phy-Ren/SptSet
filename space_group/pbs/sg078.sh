...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg078.g
set CKPT = ~/checkpoints/sg78.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg078.log

echo "=== SptSet Space Group #78 (bigmem node) ===" >>& $LOG
