...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg010.g
set CKPT = ~/checkpoints/sg10.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg010.log

echo "=== SptSet Space Group #10 ===" >& $LOG
