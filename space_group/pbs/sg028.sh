...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg028.g
set CKPT = ~/checkpoints/sg28.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg028.log

echo "=== SptSet Space Group #28 (bigmem node) ===" >& $LOG
