...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg084.g
set CKPT = ~/checkpoints/sg84.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg084.log

echo "=== SptSet Space Group #84 ===" >>& $LOG
