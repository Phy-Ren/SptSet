...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg011.g
set CKPT = ~/checkpoints/sg11.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg011.log

echo "=== SptSet Space Group #11 ===" >& $LOG
