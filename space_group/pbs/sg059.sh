...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg059.g
set CKPT = ~/checkpoints/sg59.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg059.log

echo "=== SptSet Space Group #59 (bigmem node) ===" >>& $LOG
