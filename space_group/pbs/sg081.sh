...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg081.g
set CKPT = ~/checkpoints/sg81.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg081.log

echo "=== SptSet Space Group #81 (bigmem node) ===" >>& $LOG
