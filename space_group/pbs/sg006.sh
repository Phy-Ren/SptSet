...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg006.g
set CKPT = ~/checkpoints/sg6.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg006.log

echo "=== SptSet Space Group #6 ===" >& $LOG
