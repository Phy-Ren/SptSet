...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg069.g
set CKPT = ~/checkpoints/sg69.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg069.log

echo "=== SptSet Space Group #69 (bigmem node) ===" >>& $LOG
