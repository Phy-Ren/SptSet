...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg031.g
set CKPT = ~/checkpoints/sg31.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg031.log

echo "=== SptSet Space Group #31 (bigmem node) ===" >>& $LOG
