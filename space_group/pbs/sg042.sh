...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg042.g
set CKPT = ~/checkpoints/sg42.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg042.log

echo "=== SptSet Space Group #42 (bigmem node) ===" >>& $LOG
