...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg038.g
set CKPT = ~/checkpoints/sg38.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg038.log

echo "=== SptSet Space Group #38 (bigmem node) ===" >& $LOG
