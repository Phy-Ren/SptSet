...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg066.g
set CKPT = ~/checkpoints/sg66.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg066.log

echo "=== SptSet Space Group #66 (bigmem node) ===" >>& $LOG
