...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg009.g
set CKPT = ~/checkpoints/sg9.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg009.log

echo "=== SptSet Space Group #9 ===" >& $LOG
