...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg023.g
set CKPT = ~/checkpoints/sg23.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg023.log

echo "=== SptSet Space Group #23 (bigmem node) ===" >>& $LOG
