...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg065.g
set CKPT = ~/checkpoints/sg65.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg065.log

echo "=== SptSet Space Group #65 (bigmem node) ===" >>& $LOG
