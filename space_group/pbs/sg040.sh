...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg040.g
set CKPT = ~/checkpoints/sg40.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg040.log

echo "=== SptSet Space Group #40 (bigmem node) ===" >>& $LOG
