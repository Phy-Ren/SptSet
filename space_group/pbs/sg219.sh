...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg219.g
set CKPT = ~/checkpoints/sg219.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg219.log

echo "=== SptSet Space Group #219 (HARDEST) ===" >>& $LOG
