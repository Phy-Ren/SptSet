...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg076.g
set CKPT = ~/checkpoints/sg76.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg076.log

echo "=== SptSet Space Group #76 (bigmem node) ===" >>& $LOG
