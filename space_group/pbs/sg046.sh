...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg046.g
set CKPT = ~/checkpoints/sg46.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg046.log

echo "=== SptSet Space Group #46 (bigmem node) ===" >>& $LOG
