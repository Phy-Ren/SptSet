...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg032.g
set CKPT = ~/checkpoints/sg32.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg032.log

echo "=== SptSet Space Group #32 (bigmem node) ===" >>& $LOG
