...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg054.g
set CKPT = ~/checkpoints/sg54.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg054.log

echo "=== SptSet Space Group #54 (bigmem node) ===" >>& $LOG
