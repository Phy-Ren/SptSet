...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg100.g
set CKPT = ~/checkpoints/sg100.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg100.log

echo "=== SptSet Space Group #100 ===" >>& $LOG
