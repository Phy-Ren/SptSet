...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg093.g
set CKPT = ~/checkpoints/sg93.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg093.log

echo "=== SptSet Space Group #93 ===" >>& $LOG
