...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg085.g
set CKPT = ~/checkpoints/sg85.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg085.log

echo "=== SptSet Space Group #85 (bigmem node) ===" >>& $LOG
