...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg095.g
set CKPT = ~/checkpoints/sg95.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg095.log

echo "=== SptSet Space Group #95 ===" >>& $LOG
