...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg067.g
set CKPT = ~/checkpoints/sg67.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg067.log

echo "=== SptSet Space Group #67 ===" >>& $LOG
