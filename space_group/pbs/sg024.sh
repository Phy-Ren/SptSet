...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg024.g
set CKPT = ~/checkpoints/sg24.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg024.log

echo "=== SptSet Space Group #24 (bigmem node) ===" >>& $LOG
