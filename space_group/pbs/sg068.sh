...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg068.g
set CKPT = ~/checkpoints/sg68.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg068.log

echo "=== SptSet Space Group #68 (bigmem node) ===" >>& $LOG
