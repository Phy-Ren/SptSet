...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg058.g
set CKPT = ~/checkpoints/sg58.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg058.log

echo "=== SptSet Space Group #58 (bigmem node) ===" >>& $LOG
