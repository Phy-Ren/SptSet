...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg063.g
set CKPT = ~/checkpoints/sg63.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg063.log

echo "=== SptSet Space Group #63 (bigmem node) ===" >>& $LOG
