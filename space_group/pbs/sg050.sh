...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg050.g
set CKPT = ~/checkpoints/sg50.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg050.log

echo "=== SptSet Space Group #50 (bigmem node) ===" >>& $LOG
