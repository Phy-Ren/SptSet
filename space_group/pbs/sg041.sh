...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg041.g
set CKPT = ~/checkpoints/sg41.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg041.log

echo "=== SptSet Space Group #41 (bigmem node) ===" >>& $LOG
