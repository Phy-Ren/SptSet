...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg082.g
set CKPT = ~/checkpoints/sg82.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg082.log

echo "=== SptSet Space Group #82 ===" >>& $LOG
