...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg106.g
set CKPT = ~/checkpoints/sg106.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg106.log

echo "=== SptSet Space Group #106 ===" >>& $LOG
