...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg075.g
set CKPT = ~/checkpoints/sg75.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg075.log

echo "=== SptSet Space Group #75 (bigmem node) ===" >>& $LOG
