...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg033.g
set CKPT = ~/checkpoints/sg33.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg033.log

echo "=== SptSet Space Group #33 (bigmem node) ===" >>& $LOG
