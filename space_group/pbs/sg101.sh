...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg101.g
set CKPT = ~/checkpoints/sg101.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg101.log

echo "=== SptSet Space Group #101 ===" >>& $LOG
