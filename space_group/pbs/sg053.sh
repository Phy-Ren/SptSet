...
set SETUP = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/setup/sg053.g
set CKPT = ~/checkpoints/sg53.ws
set LOG = /home/user/xyren/software/gap-4.13.1/pkg/SptSet/space_group/results/sg053.log

echo "=== SptSet Space Group #53 (bigmem node) ===" >>& $LOG
